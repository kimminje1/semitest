...
@WebServlet("/admin/notice/add")
public class AddNoticeController extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final String UPLOAD_DIRECTORY = "D:/GudiSpring/img/noticeboard/";//파일저장위치
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) 
        ...
        = req.getRequestDispatcher("/jsp/admin/notice/newNoticeBoardForm.jsp");
                        ...
                        if (!fileName.isEmpty()) {
                        	...
                        	if (!(fileName.endsWith(".png") || fileName.endsWith(".jpg") || fileName.endsWith(".webp")
                                ...
                                // 타임스탬프를 추가하여 파일 이름을 유니크하게 만듦
                                    ...
                                    filePaths.add("noticeboard/" + uniqueFileName); // 리스트에 파일 경로 추가
...
//            System.out.println("Text: " + text);
         ...
         // 선택된 파일 필터링
            ...
            // 게시글 목록 페이지로 리다이렉트
            res.sendRedirect(req.getContextPath() + "/admin/notice/list");
