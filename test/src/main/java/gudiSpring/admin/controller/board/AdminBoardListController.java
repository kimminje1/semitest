	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		  int recordsPerPage = 10;
	        ...
	        try {
	            ...
	            AdminDao adminBoardDao = new AdminDao();
	            adminBoardDao.setConnection(conn);
	            List<ReviewBoardDto> boardList = adminBoardDao.selectList(start, end);

	            // 총 게시글 수 및 페이지 수 계산
	            int totalRecords = adminBoardDao.getTotalCount();
