...
public class PlaceListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			case null, "selectAll", "removePlacesForm": {
				...
				ArrayList<PlaceDto> placeList = (ArrayList<PlaceDto>) handlePlaceSelectForm(req, res);
			...
			case "searchPlaceForm": {
				...
				ArrayList<PlaceDto> placeList = (ArrayList<PlaceDto>) handlePlaceSearchForm(req, res);
	...
	private List<PlaceDto> handlePlaceSelectForm(HttpServletRequest req, HttpServletResponse res) {
		...
		// 임시로 사용 중
		ArrayList<PlaceDto> placeList = (ArrayList<PlaceDto>) placeDao.selectPlaceList();
	...
	private List<PlaceDto> handlePlaceSearchForm(HttpServletRequest req, HttpServletResponse res) {
		...
		ArrayList<PlaceDto> placeList = (ArrayList<PlaceDto>) placeDao.searchPlaceList(placeName);
