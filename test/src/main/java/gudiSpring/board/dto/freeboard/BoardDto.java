...
public class BoardDto {
		...
		public String toString() {
			return "BoardDto [contentNo=" + contentNo + ", contentSubject=" + contentSubject + ", contentText="
		...
		public BoardDto(int contentNo, String contentSubject, String contentText, String contentFile,
