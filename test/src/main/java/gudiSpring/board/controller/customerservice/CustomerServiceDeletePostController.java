...
@WebServlet("/board/customerserviceboard/delete")
public class CustomerServiceDeletePostController extends HttpServlet{
		  ...
		  int contentNo = Integer.parseInt(req.getParameter("contentNo"));
	        ...
	        try {
	         ...
	         // 게시글 정보 가져오기
	            ...
	            res.sendRedirect(req.getContextPath() + "/board/customerserviceboardcustomerserviceboard/list");
	}catch (Exception e) {
