...
@WebServlet("/board/customerserviceboard/add")
public class CustomerServiceAddBoardController extends HttpServlet {

    private static final long serialVersionUID = 1L;
    private static final String UPLOAD_DIRECTORY = "D:/GudiSpring/img/customerserviceboard/";//파일저장위치
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) 
        ...
        = req.getRequestDispatcher("/jsp/board/customerservice/newCustomerServiceBoardForm.jsp");
                        ...
                        if (!fileName.isEmpty()) {
                        	...
                        	if (!(fileName.endsWith(".png") || fileName.endsWith(".jpg") || fileName.endsWith(".webp")
                                ...
                                // 타임스탬프를 추가하여 파일 이름을 유니크하게 만듦
                                    ...
                                    filePaths.add("customerserviceboard/" + uniqueFileName); // 리스트에 파일 경로 추가
...
//            System.out.println("Text: " + text);
         ...
         // 선택된 파일 필터링
            ...
            System.out.println("add뜨나???"+finalFiles);
