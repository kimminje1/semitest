...
@WebServlet(value = "/area/restaurant")
public class RestaurantAreaListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/jsp/area/restaurantAreaListView.jsp");
