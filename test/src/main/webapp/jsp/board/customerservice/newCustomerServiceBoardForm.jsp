	...
	<head>
	    ...
	    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/board/customerservice/newCustomerServiceBoard.css">
	    ...
	    <!-- JavaScript 파일 로드 -->
	    <script defer src="${pageContext.request.contextPath}/js/board/customerservice/newCustomerServiceBoard.js"></script>
	</head>
	...
	<body class="bodystyle">
	    ...
	    <div id="main-container" class="form-container">
	        ...
	        <form  action="<%= request.getContextPath() %>/board/customerserviceboard/add" method="post" enctype="multipart/form-data">
			...
			<div id="file-list"></div>
	            ...
	            <input type="submit" id="completeButton" value="작성 완료" class="submit-button">
	        </form>
	
	        <a href="<%= request.getContextPath() %>/board/customerserviceboard/list">목록으로 돌아가기</a>
	    </div>
