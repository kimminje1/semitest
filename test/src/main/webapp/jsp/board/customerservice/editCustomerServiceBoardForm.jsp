...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/board/customerservice/editCustomerServiceBoard.css">
    ...
    <script defer src="${pageContext.request.contextPath}/js/board/customerservice/editCustomerServiceBoard.js"></script>
</head>
<body id="body-style">
<jsp:include page="/jsp/common/header.jsp" />
<div id="main-container">
    <h2>게시글 수정</h2>
    <form id="editForm" action="<%= request.getContextPath() %>/board/customerserviceboard/edit" method="post" enctype="multipart/form-data">
		    ...
		    <div id="existing-file-list">
		        ...
		        <c:forEach var="file" items="${boardDto.contentFiles}">
		            <div id="file-${file}" class="delete-form-container">
		                ...
		                <form class="delete-form" action="${pageContext.request.contextPath}/board/customerserviceboard/deleteFile" method="post">
		                    <input type="hidden" name="contentNo" value="${boardDto.contentNo}">
    ...
    <a href="<%= request.getContextPath() %>/board/customerserviceboard/list" class="back-link">목록으로 돌아가기</a>
</div>
