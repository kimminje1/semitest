	...
	<head>
	    ...
	    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/admin/notice/newNoticeBoard.css">
	    ...
	    <!-- JavaScript 파일 로드 --> 
	    <script defer src="${pageContext.request.contextPath}/js/admin/notice/newNoticeBoard.js"></script>
	</head>
	...
	<body class="bodystyle">
	    ...
	    <div id="main-container" class="form-container">
	        ...
	        <form  action="<%= request.getContextPath() %>/admin/notice/add" method="post" enctype="multipart/form-data">
	        ...
	        <a href="<%= request.getContextPath() %>/admin/notice/list">목록으로 돌아가기</a>
	    </div>
