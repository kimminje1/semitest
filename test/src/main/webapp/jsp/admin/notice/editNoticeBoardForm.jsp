...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/admin/notice/editNoticeBoard.css">
    ...
    <script defer src="${pageContext.request.contextPath}/js/admin/notice/editNoticeBoard.js"></script>
</head>
<body id="body-style">

<div id="main-container">
    <h2>게시글 수정</h2>
    <form id="editForm" action="<%= request.getContextPath() %>/admin/notice/edit" method="post" enctype="multipart/form-data">
		    ...
		    <div id="existing-file-list">
		        ...
		        <c:forEach var="file" items="${boardDto.contentFiles}">
		            <div id="file-${file}" class="delete-form-container">
		                ...
		                <form class="delete-form" action="${pageContext.request.contextPath}/admin/notice/deleteFile" method="post">
		                    <input type="hidden" name="contentNo" value="${boardDto.contentNo}">
    ...
    <a href="<%= request.getContextPath() %>/admin/notice/list" class="back-link">목록으로 돌아가기</a>
</div>
