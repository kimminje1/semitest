...
<link rel="stylesheet"
  href="${pageContext.request.contextPath}/css/admin/place/addPlace.css" />
    ...
    <div class="main-container__content">
      ...
      <div class="place-form">
        <form action="./add" method="post" enctype="multipart/form-data">
          ...
          <div class="select-container">
            ...
            <div class="place-form__content">
              ...
              <select name="areaNo" class="text--black">
                <option value="1" selected="selected" class="text--black width--md">경기도, 서울</option>
          ...
          <div class="place-form__content">
            <label class="text--black text--bold width--sm">주소</label> 
            <input name="plAddress" class="text--black width--lg" />
          </div>

          <div class="place-form__content">
            <label class="text--black text--bold width--md">전화번호</label> 
            <input name="plPhone" placeholder="숫자만 입력" class="text--black width--md" />
          </div>
          ...
          <div class="place-form__content">
            ...
            <input type="file" name="image"
              ...
              onchange="previewImage(this);" class="text--black" /> 
            <img id="imagePreview"
              src="#" alt="Image Priview"
              style="display: none; width: 700px; height: 500px; margin: auto;" />
          </div>
