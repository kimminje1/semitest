		...
		<div class="main-container__content">
			<ul>
				<c:forEach var="pensionDto" items="${pensionList}">
					<li>
						<form action="${pageContext.request.contextPath}/place/pension/infomation" method="get">
						<input type="hidden" name="placeNo" value="${pensionDto.placeNo}" />
						<button type="submit" class="areaBtn">${pensionDto.placeName}</button>			
						</form>
					</li>
				</c:forEach>
			</ul>
